...
public class GetHifResultsRecord extends TableRecordImpl<GetHifResultsRecord> implements Record14<Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double> {
    ...
    @Override
    public Row14<Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double> valuesRow() {
    ...
    @Override
    public GetHifResultsRecord values(Integer value1, Integer value2, Integer value3, Double value4, Double value5, Double value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Double value13, Double value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GetHifResultsRecord(Integer gridCol, Integer gridRow, Integer hifId, Double pointEstimate, Double population, Double baselineAq, Double scenarioAq, Double deltaAq, Double mean, Double baseline, Double standardDev, Double variance, Double pct_2_5, Double pct_97_5) {
        super(GetHifResults.GET_HIF_RESULTS);
