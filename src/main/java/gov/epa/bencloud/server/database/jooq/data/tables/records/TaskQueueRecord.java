...
public class TaskQueueRecord extends UpdatableRecordImpl<TaskQueueRecord> implements Record14<Integer, String, Integer, String, String, String, String, String, String, Integer, String, Boolean, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row14<Integer, String, Integer, String, String, String, String, String, String, Integer, String, Boolean, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public TaskQueueRecord value9(String value) {
        setTaskParameters(value);
        return this;
    }

    @Override
    public TaskQueueRecord value10(Integer value) {
        setTaskPercentage(value);
        return this;
    }

    @Override
    public TaskQueueRecord value11(String value) {
        setTaskMessage(value);
        return this;
    }

    @Override
    public TaskQueueRecord value12(Boolean value) {
    ...
    @Override
    public TaskQueueRecord value14(LocalDateTime value) {
        setTaskStartedDate(value);
        return this;
    }

    @Override
    public TaskQueueRecord values(Integer value1, String value2, Integer value3, String value4, String value5, String value6, String value7, String value8, String value9, Integer value10, String value11, Boolean value12, LocalDateTime value13, LocalDateTime value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskQueueRecord(Integer taskId, String taskUserIdentifier, Integer taskPriority, String taskUuid, String taskParentUuid, String taskName, String taskDescription, String taskType, String taskParameters, Integer taskPercentage, String taskMessage, Boolean taskInProcess, LocalDateTime taskSubmittedDate, LocalDateTime taskStartedDate) {
        super(TaskQueue.TASK_QUEUE);
