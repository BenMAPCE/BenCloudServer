...
public class HifResultDatasetRecord extends UpdatableRecordImpl<HifResultDatasetRecord> implements Record10<Integer, String, String, Integer, Integer, Integer, Integer, JSON, String, Short> {
    ...
    @Override
    public Row10<Integer, String, String, Integer, Integer, Integer, Integer, JSON, String, Short> valuesRow() {
    ...
    @Override
    public HifResultDatasetRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, JSON value8, String value9, Short value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HifResultDatasetRecord(Integer id, String taskUuid, String name, Integer populationDatasetId, Integer populationYear, Integer baselineAqLayerId, Integer scenarioAqLayerId, JSON taskLog, String userId, Short sharingScope) {
        super(HifResultDataset.HIF_RESULT_DATASET);
