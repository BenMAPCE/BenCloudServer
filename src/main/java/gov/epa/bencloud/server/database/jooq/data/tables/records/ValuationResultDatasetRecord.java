...
public class ValuationResultDatasetRecord extends UpdatableRecordImpl<ValuationResultDatasetRecord> implements Record6<Integer, String, Integer, String, Integer, JSON> {
    ...
    @Override
    public Row6<Integer, String, Integer, String, Integer, JSON> valuesRow() {
    ...
    @Override
    public ValuationResultDatasetRecord values(Integer value1, String value2, Integer value3, String value4, Integer value5, JSON value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ValuationResultDatasetRecord(Integer id, String taskUuid, Integer hifResultDatasetId, String name, Integer variableDatasetId, JSON taskLog) {
        super(ValuationResultDataset.VALUATION_RESULT_DATASET);
