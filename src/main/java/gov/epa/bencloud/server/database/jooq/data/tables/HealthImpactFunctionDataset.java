...
public class HealthImpactFunctionDataset extends TableImpl<HealthImpactFunctionDatasetRecord> {
     ...
     */
    public final TableField<HealthImpactFunctionDatasetRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field("nextval('data.health_impact_function_dataset_id_seq1'::regclass)", SQLDataType.INTEGER)), this, "");
