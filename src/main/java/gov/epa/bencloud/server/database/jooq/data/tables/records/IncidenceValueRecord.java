...
public class IncidenceValueRecord extends TableRecordImpl<IncidenceValueRecord> implements Record5<Integer, Integer, Integer, Integer, Double> {
    ...
    @Override
    public IncidenceValueRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Double value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public IncidenceValueRecord(Integer incidenceEntryId, Integer gridCellId, Integer gridCol, Integer gridRow, Double value) {
        super(IncidenceValue.INCIDENCE_VALUE);
