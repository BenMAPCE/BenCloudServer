...
public class PopulationGrowthRecord extends UpdatableRecordImpl<PopulationGrowthRecord> implements Record8<Short, Short, Integer, Integer, Integer, Integer, Integer, Double> {
    ...
    @Override
    public PopulationGrowthRecord value1(Short value) {
        setBasePopYear(value);
        return this;
    }

    @Override
    public PopulationGrowthRecord value2(Short value) {
        setPopYear(value);
        return this;
    }
    ...
    @Override
    public PopulationGrowthRecord value6(Integer value) {
        setAgeRangeId(value);
        return this;
    }

    @Override
    public PopulationGrowthRecord value7(Integer value) {
        setGridCellId(value);
        return this;
    }

    @Override
    public PopulationGrowthRecord value8(Double value) {
        setGrowthValue(value);
        return this;
    }

    @Override
    public PopulationGrowthRecord values(Short value1, Short value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Double value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PopulationGrowthRecord(Short basePopYear, Short popYear, Integer raceId, Integer genderId, Integer ethnicityId, Integer ageRangeId, Integer gridCellId, Double growthValue) {
        super(PopulationGrowth.POPULATION_GROWTH);
