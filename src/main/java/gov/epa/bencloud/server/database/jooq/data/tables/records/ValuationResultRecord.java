...
public class ValuationResultRecord extends TableRecordImpl<ValuationResultRecord> implements Record14<Integer, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Double, Double[]> {
    ...
    @Override
    public Row14<Integer, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double, Double, Double[]> valuesRow() {
    ...
    @Override
    public ValuationResultRecord value6(Integer value) {
        setGridCellId(value);
        return this;
    }
    ...
    @Override
    public ValuationResultRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Double value13, Double[] value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ValuationResultRecord(Integer valuationResultDatasetId, Integer vfId, Integer hifId, Integer gridCol, Integer gridRow, Integer gridCellId, Double population, Double result, Double resultMean, Double standardDev, Double resultVariance, Double pct_2_5, Double pct_97_5, Double[] percentiles) {
        super(ValuationResult.VALUATION_RESULT);
