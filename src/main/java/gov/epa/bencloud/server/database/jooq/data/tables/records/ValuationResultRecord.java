...
public class ValuationResultRecord extends TableRecordImpl<ValuationResultRecord> implements Record17<Integer, Integer, Integer, Integer, Integer, Long, Double, Double, Double, Double, Double, Double, Double, Double[], Integer, Integer, Double[]> {
    ...
    @Override
    public Row17<Integer, Integer, Integer, Integer, Integer, Long, Double, Double, Double, Double, Double, Double, Double, Double[], Integer, Integer, Double[]> valuesRow() {
    ...
    public Field<Double[]> field17() {
        return ValuationResult.VALUATION_RESULT.PERCENTILES_ARRAY;
    }
    ...
    @Override
    public ValuationResultRecord value17(Double[] value) {
        setPercentilesArray(value);
        return this;
    }

    @Override
    public ValuationResultRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Long value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Double value13, Double[] value14, Integer value15, Integer value16, Double[] value17) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
