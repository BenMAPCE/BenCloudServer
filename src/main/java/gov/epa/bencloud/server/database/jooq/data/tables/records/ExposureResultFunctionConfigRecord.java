...
public class ExposureResultFunctionConfigRecord extends TableRecordImpl<ExposureResultFunctionConfigRecord> implements Record12<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> {
    ...
    @Override
    public ExposureResultFunctionConfigRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9, Integer value10, Integer value11, Integer value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
