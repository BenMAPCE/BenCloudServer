...
public class HifResultRecord extends TableRecordImpl<HifResultRecord> implements Record18<Integer, Integer, Integer, Integer, Long, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double[]> {
    ...
    @Override
    public Row18<Integer, Integer, Integer, Integer, Long, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double[]> valuesRow() {
    ...
    @Override
    public HifResultRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Long value5, Double value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Double value13, Double value14, Double value15, Double value16, Double value17, Double[] value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HifResultRecord(Integer hifResultDatasetId, Integer hifId, Integer gridCol, Integer gridRow, Long gridCellId, Double population, Double deltaAq, Double baselineAq, Double scenarioAq, Double incidence, Double result, Double baseline, Double resultMean, Double standardDev, Double resultVariance, Double pct_2_5, Double pct_97_5, Double[] percentiles) {
        super(HifResult.HIF_RESULT);
