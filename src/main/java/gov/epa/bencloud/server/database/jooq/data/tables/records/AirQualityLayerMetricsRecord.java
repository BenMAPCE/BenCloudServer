...
public class AirQualityLayerMetricsRecord extends UpdatableRecordImpl<AirQualityLayerMetricsRecord> implements Record11<Integer, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double> {
    ...
    @Override
    public Row11<Integer, Integer, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double> valuesRow() {
    ...
    @Override
    public AirQualityLayerMetricsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Double value7, Double value8, Double value9, Double value10, Double value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AirQualityLayerMetricsRecord(Integer id, Integer airQualityLayerId, Integer metricId, Integer seasonalMetricId, Integer annualStatisticId, Integer cellCount, Double minValue, Double maxValue, Double meanValue, Double pct_2_5, Double pct_97_5) {
        super(AirQualityLayerMetrics.AIR_QUALITY_LAYER_METRICS);
