...
public class PopulationValueRecord extends TableRecordImpl<PopulationValueRecord> implements Record3<Integer, Integer, Double> {
    ...
    @Override
    public PopulationValueRecord values(Integer value1, Integer value2, Double value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public PopulationValueRecord(Integer popEntryId, Integer gridCellId, Double popValue) {
        super(PopulationValue.POPULATION_VALUE);
