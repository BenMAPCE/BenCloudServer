...
public class EndpointRecord extends UpdatableRecordImpl<EndpointRecord> implements Record4<Integer, Short, String, String> {
    ...
    /**
     * Setter for <code>data.endpoint.display_name</code>.
     */
    ...
    /**
     * Getter for <code>data.endpoint.display_name</code>.
     */
    ...
    public Field<String> field4() {
        return Endpoint.ENDPOINT.DISPLAY_NAME;
    }
    ...
    @Override
    public EndpointRecord values(Integer value1, Short value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EndpointRecord(Integer id, Short endpointGroupId, String name, String displayName) {
        super(Endpoint.ENDPOINT);
