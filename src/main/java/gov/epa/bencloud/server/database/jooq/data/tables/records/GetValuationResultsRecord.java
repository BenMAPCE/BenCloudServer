...
public class GetValuationResultsRecord extends TableRecordImpl<GetValuationResultsRecord> implements Record10<Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Double> {
    ...
    @Override
    public GetValuationResultsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Double value5, Double value6, Double value7, Double value8, Double value9, Double value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GetValuationResultsRecord(Integer gridCol, Integer gridRow, Integer hifId, Integer vfId, Double pointEstimate, Double mean, Double standardDev, Double variance, Double pct_2_5, Double pct_97_5) {
        super(GetValuationResults.GET_VALUATION_RESULTS);
