...
public class Indexes {
    ...
    public static final Index USA_CT_GRIDS_DISSOLVE_GEOM_IDX = Internal.createIndex(DSL.name("usa_ct_grids_dissolve_geom_idx"), UsaCtGridsDissolve.USA_CT_GRIDS_DISSOLVE, new OrderField[] { UsaCtGridsDissolve.USA_CT_GRIDS_DISSOLVE.GEOM }, false);
}
