...
public class Indexes {
    ...
    public static final Index US_CENSUS_TRACTS_2020_GEOM_IDX = Internal.createIndex(DSL.name("us_census_tracts_2020_geom_idx"), UsCensusTracts_2020.US_CENSUS_TRACTS_2020, new OrderField[] { UsCensusTracts_2020.US_CENSUS_TRACTS_2020.GEOM }, false);
    ...
    public static final Index US_CMAQ_12KM_NATION_STRAIGHTCLIP_GEOM_IDX = Internal.createIndex(DSL.name("us_cmaq_12km_nation_straightclip_geom_idx"), UsCmaq_12kmNationStraightclip.US_CMAQ_12KM_NATION_STRAIGHTCLIP, new OrderField[] { UsCmaq_12kmNationStraightclip.US_CMAQ_12KM_NATION_STRAIGHTCLIP.GEOM }, false);
    public static final Index US_COUNTY_2020_GEOM_IDX = Internal.createIndex(DSL.name("us_county_2020_geom_idx"), UsCounty_2020.US_COUNTY_2020, new OrderField[] { UsCounty_2020.US_COUNTY_2020.GEOM }, false);
