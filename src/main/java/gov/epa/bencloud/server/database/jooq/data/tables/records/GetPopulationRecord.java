...
public class GetPopulationRecord extends TableRecordImpl<GetPopulationRecord> implements Record6<Integer, Integer, Integer, Integer, Integer, Double> {
    ...
    @Override
    public Row6<Integer, Integer, Integer, Integer, Integer, Double> valuesRow() {
    ...
    @Override
    public GetPopulationRecord value1(Integer value) {
        setGridCellId(value);
        return this;
    }
    ...
    @Override
    public GetPopulationRecord value6(Double value) {
        setPopValue(value);
        return this;
    }

    @Override
    public GetPopulationRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Double value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GetPopulationRecord(Integer gridCellId, Integer raceId, Integer ethnicityId, Integer genderId, Integer ageRangeId, Double popValue) {
        super(GetPopulation.GET_POPULATION);
