...
public class GetPopulationRecord extends TableRecordImpl<GetPopulationRecord> implements Record6<Long, Integer, Integer, Integer, Integer, Double> {
    ...
    @Override
    public Row6<Long, Integer, Integer, Integer, Integer, Double> valuesRow() {
    ...
    @Override
    public GetPopulationRecord values(Long value1, Integer value2, Integer value3, Integer value4, Integer value5, Double value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GetPopulationRecord(Long gridCellId, Integer raceId, Integer ethnicityId, Integer genderId, Integer ageRangeId, Double popValue) {
        super(GetPopulation.GET_POPULATION);
