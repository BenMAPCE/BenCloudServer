...
public class GetPopulationRecord extends TableRecordImpl<GetPopulationRecord> implements Record6<Integer, Integer, Integer, Integer, Integer, BigDecimal> {
    ...
    @Override
    public GetPopulationRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, BigDecimal value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GetPopulationRecord(Integer gridCellId, Integer raceId, Integer ethnicityId, Integer genderId, Integer ageRangeId, BigDecimal popValue) {
        super(GetPopulation.GET_POPULATION);
