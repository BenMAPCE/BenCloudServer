...
public class CrosswalkEntryRecord extends TableRecordImpl<CrosswalkEntryRecord> implements Record8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, BigDecimal> {
     ...
     */
    public void setSourceGridCellId(Integer value) {
        set(3, value);
    }
     ...
     */
    public Integer getSourceGridCellId() {
     ...
     */
    public void setTargetGridCellId(Integer value) {
        set(6, value);
    }
     ...
     */
    public Integer getTargetGridCellId() {
    ...
    @Override
    public Row8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, BigDecimal> valuesRow() {
    ...
    @Override
    public CrosswalkEntryRecord value4(Integer value) {
    ...
    @Override
    public CrosswalkEntryRecord value7(Integer value) {
    ...
    @Override
    public CrosswalkEntryRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, BigDecimal value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CrosswalkEntryRecord(Integer crosswalkId, Integer sourceCol, Integer sourceRow, Integer sourceGridCellId, Integer targetCol, Integer targetRow, Integer targetGridCellId, BigDecimal percentage) {
        super(CrosswalkEntry.CROSSWALK_ENTRY);
