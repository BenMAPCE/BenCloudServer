...
public class CrosswalkEntryRecord extends TableRecordImpl<CrosswalkEntryRecord> implements Record8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Double> {
    ...
    @Override
    public CrosswalkEntryRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Double value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CrosswalkEntryRecord(Integer crosswalkId, Integer sourceCol, Integer sourceRow, Integer sourceGridCellId, Integer targetCol, Integer targetRow, Integer targetGridCellId, Double percentage) {
        super(CrosswalkEntry.CROSSWALK_ENTRY);
