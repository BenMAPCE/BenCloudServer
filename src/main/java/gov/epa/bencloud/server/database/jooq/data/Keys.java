...
public class Keys {
    ...
    public static final UniqueKey<PopulationEntryRecord> POPULATION_ENTRY_PK = Internal.createUniqueKey(PopulationEntry.POPULATION_ENTRY, DSL.name("population_entry_pk"), new TableField[] { PopulationEntry.POPULATION_ENTRY.ID }, true);
