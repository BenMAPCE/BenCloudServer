...
import gov.epa.bencloud.server.database.jooq.data.tables.records.AgeRangeRecord;
...
import gov.epa.bencloud.server.database.jooq.data.tables.records.PopConfigRaceRecord;
...
public class Keys {
    ...
    public static final UniqueKey<AirQualityLayerMetricsRecord> AIR_QUALITY_LAYER_METRICS_PKEY = Internal.createUniqueKey(AirQualityLayerMetrics.AIR_QUALITY_LAYER_METRICS, DSL.name("air_quality_layer_metrics_pkey"), new TableField[] { AirQualityLayerMetrics.AIR_QUALITY_LAYER_METRICS.ID }, true);
    ...
    public static final UniqueKey<ExposureFunctionRecord> EXPOSURE_FUNCTION_PKEY = Internal.createUniqueKey(ExposureFunction.EXPOSURE_FUNCTION, DSL.name("exposure_function_pkey"), new TableField[] { ExposureFunction.EXPOSURE_FUNCTION.ID }, true);
    ...
    public static final UniqueKey<PopulationGrowthRecord> POPULATION_GROWTH_PK = Internal.createUniqueKey(PopulationGrowth.POPULATION_GROWTH, DSL.name("population_growth_pk"), new TableField[] { PopulationGrowth.POPULATION_GROWTH.RACE_ID, PopulationGrowth.POPULATION_GROWTH.GENDER_ID, PopulationGrowth.POPULATION_GROWTH.ETHNICITY_ID, PopulationGrowth.POPULATION_GROWTH.AGE_RANGE_ID, PopulationGrowth.POPULATION_GROWTH.GRID_CELL_ID, PopulationGrowth.POPULATION_GROWTH.POP_YEAR, PopulationGrowth.POPULATION_GROWTH.BASE_POP_YEAR }, true);
    public static final UniqueKey<PopulationGrowthWeightRecord> POPULATION_GROWTH_WEIGHT_PK = Internal.createUniqueKey(PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT, DSL.name("population_growth_weight_pk"), new TableField[] { PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.POP_DATASET_ID, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.BASE_POP_YEAR, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.RACE_ID, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.ETHNICITY_ID, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.SOURCE_GRID_CELL_ID, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.TARGET_GRID_CELL_ID }, true);
    ...
    public static final UniqueKey<TaskBatchRecord> TASK_BATCH_PK = Internal.createUniqueKey(TaskBatch.TASK_BATCH, DSL.name("task_batch_pk"), new TableField[] { TaskBatch.TASK_BATCH.ID }, true);
