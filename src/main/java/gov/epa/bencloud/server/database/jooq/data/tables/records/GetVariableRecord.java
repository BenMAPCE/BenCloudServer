...
public class GetVariableRecord extends TableRecordImpl<GetVariableRecord> implements Record3<String, Long, Double> {
    ...
    @Override
    public Row3<String, Long, Double> valuesRow() {
    ...
    @Override
    public GetVariableRecord values(String value1, Long value2, Double value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public GetVariableRecord(String variableName, Long gridCellId, Double value) {
        super(GetVariable.GET_VARIABLE);
