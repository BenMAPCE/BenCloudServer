...
public class Indexes {
    ...
    public static final Index POPULATION_GROWTH_WEIGHT_TARGET_IDX = Internal.createIndex(DSL.name("population_growth_weight_target_idx"), PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT, new OrderField[] { PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.POP_DATASET_ID, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.POP_YEAR, PopulationGrowthWeight.POPULATION_GROWTH_WEIGHT.TARGET_GRID_CELL_ID }, false);
    public static final Index POPULATION_GROWTH_WT_IDX = Internal.createIndex(DSL.name("population_growth_wt_idx"), PopulationGrowth.POPULATION_GROWTH, new OrderField[] { PopulationGrowth.POPULATION_GROWTH.POP_YEAR, PopulationGrowth.POPULATION_GROWTH.RACE_ID, PopulationGrowth.POPULATION_GROWTH.ETHNICITY_ID, PopulationGrowth.POPULATION_GROWTH.GRID_CELL_ID }, false);
