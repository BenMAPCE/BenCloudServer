...
public class GridDefinitionRecord extends UpdatableRecordImpl<GridDefinitionRecord> implements Record11<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON> {
    ...
    @Override
    public Row11<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON> valuesRow() {
    ...
    @Override
    public GridDefinitionRecord values(Integer value1, String value2, Integer value3, Integer value4, String value5, Integer value6, String value7, String value8, String value9, Short value10, JSON value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GridDefinitionRecord(Integer id, String name, Integer colCount, Integer rowCount, String isAdminLayer, Integer drawPriority, String outlineColor, String tableName, String userId, Short shareScope, JSON taskLog) {
        super(GridDefinition.GRID_DEFINITION);
