...
public class GridDefinitionRecord extends UpdatableRecordImpl<GridDefinitionRecord> implements Record13<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON, Short, Boolean> {
    ...
    /**
     * Setter for <code>data.grid_definition.user_id</code>.
     */
    ...
    /**
     * Getter for <code>data.grid_definition.user_id</code>.
     */
    ...
    /**
     * Setter for <code>data.grid_definition.share_scope</code>.
     */
    ...
    /**
     * Getter for <code>data.grid_definition.share_scope</code>.
     */
    ...
    /**
     * Setter for <code>data.grid_definition.task_log</code>.
     */
    ...
    /**
     * Getter for <code>data.grid_definition.task_log</code>.
     */
    ...
    /**
     * Setter for <code>data.grid_definition.archive</code>.
     */
    public void setArchive(Short value) {
        set(11, value);
    }

    /**
     * Getter for <code>data.grid_definition.archive</code>.
     */
    ...
    /**
     * Setter for <code>data.grid_definition.epa_standard</code>.
     */
    ...
    /**
     * Getter for <code>data.grid_definition.epa_standard</code>.
     */
    ...
    @Override
    public Row13<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON, Short, Boolean> valuesRow() {
    ...
    public Field<String> field9() {
        return GridDefinition.GRID_DEFINITION.USER_ID;
    }

    @Override
    public Field<Short> field10() {
        return GridDefinition.GRID_DEFINITION.SHARE_SCOPE;
    }

    @Override
    public Field<JSON> field11() {
        return GridDefinition.GRID_DEFINITION.TASK_LOG;
    }

    @Override
    public Field<Short> field12() {
        return GridDefinition.GRID_DEFINITION.ARCHIVE;
    }

    @Override
    public Field<Boolean> field13() {
        return GridDefinition.GRID_DEFINITION.EPA_STANDARD;
    }
    ...
    @Override
    public GridDefinitionRecord value9(String value) {
        setUserId(value);
        return this;
    }

    @Override
    public GridDefinitionRecord value10(Short value) {
        setShareScope(value);
        return this;
    }

    @Override
    public GridDefinitionRecord value11(JSON value) {
        setTaskLog(value);
        return this;
    }

    @Override
    public GridDefinitionRecord value12(Short value) {
        setArchive(value);
        return this;
    }

    @Override
    public GridDefinitionRecord value13(Boolean value) {
        setEpaStandard(value);
        return this;
    }

    @Override
    public GridDefinitionRecord values(Integer value1, String value2, Integer value3, Integer value4, String value5, Integer value6, String value7, String value8, String value9, Short value10, JSON value11, Short value12, Boolean value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GridDefinitionRecord(Integer id, String name, Integer colCount, Integer rowCount, String isAdminLayer, Integer drawPriority, String outlineColor, String tableName, String userId, Short shareScope, JSON taskLog, Short archive, Boolean epaStandard) {
        super(GridDefinition.GRID_DEFINITION);
