...
public class GridDefinitionRecord extends UpdatableRecordImpl<GridDefinitionRecord> implements Record12<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON, Short> {
    ...
    @Override
    public Row12<Integer, String, Integer, Integer, String, Integer, String, String, String, Short, JSON, Short> valuesRow() {
    ...
    @Override
    public GridDefinitionRecord values(Integer value1, String value2, Integer value3, Integer value4, String value5, Integer value6, String value7, String value8, String value9, Short value10, JSON value11, Short value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GridDefinitionRecord(Integer id, String name, Integer colCount, Integer rowCount, String isAdminLayer, Integer drawPriority, String outlineColor, String tableName, String userId, Short shareScope, JSON taskLog, Short archive) {
        super(GridDefinition.GRID_DEFINITION);
