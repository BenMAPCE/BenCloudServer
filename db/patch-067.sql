/**** Bypass crosswalk in get_population for 12km -> 12km request ****/
...
declare
	...
	_base_year integer;
begin
-- 2025-08-19 Fix column ordering. Add override to convert 12km full to 12km clipped without crosswalk
...
-- Throw exception if data_set_id is not found in data.population_dataset.id
	...
	if _source_grid_definition_id = 77 AND _output_grid_definition_id = 28 then
		RAISE NOTICE 'Detected 12km to 12km. No crosswalk needed.';
		_output_grid_definition_id =  77;
	end if;
